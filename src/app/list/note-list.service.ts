...
export class NoteListService {
  ...
  public getMatchingNotesList(request?): Observable<GenericResponseModelInterface> {
    try {
      return this.httpGateway.doPost(IRemember.apiEndPoints.iRemMatchingNotesList,
        request)
        .pipe(
          catchError(e => {
            this.authService.showAlert(e.error && e.error.msg ? e.error.msg : e.message);
